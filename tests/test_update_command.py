...
from composer.cli import parse_update_args
...
class UpdateCommandTests(unittest.TestCase):
    ...
    def test_only_pulls_without_recreating(self):
        launcher = DockerComposeLauncher()
        with patch.dict(os.environ, {}, clear=True):
            launcher.configure_update(["-o", "web"])
