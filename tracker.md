...
- 2026-09-04: README documents `composer dlux-update`; `docs/executor-hardening.md` §3C documents the agent-stages/executor-swaps split and the two new socket ops.
